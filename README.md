...
- RF-04 and RF-05: accepted at their recorded chain heads; RF-06 is accepted; RF-07 remains open only for genuinely deferred runtime-dependent gates; RF-08 and RF-09 are independently accepted; RF-10 corrective is published for independent review; RF-11 is not started; complete runtime/deployment is not reached; production is not ready.
