...
from mayak.modules.notification_delivery.runtime import (
    FakeOutcomeClass, ReconciliationDisposition, TrustedReconciliationEvidence,
)
...
def test_trusted_evidence_is_committed_and_referenced() -> None:
    evidence = TrustedReconciliationEvidence(__import__("uuid").uuid4(), "a" * 64, "resolution-rf24", ReconciliationDisposition.NO_EFFECT_RETRY, True, ("evidence-rf24",))
