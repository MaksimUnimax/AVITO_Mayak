...
def _check_lifecycle(item: dict[str, Any]) -> None:
    ...
    expected_to_states = ["DRAFT", "READY", "ACTIVE", "PAUSED", "ACTIVE", "ARCHIVED", "READY", "ARCHIVED", "PERMANENTLY_DELETED"]
    _require([row["to_state"] for row in p["event_rows"]] == expected_to_states, "lifecycle event semantics")
