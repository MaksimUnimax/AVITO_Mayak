...
RULES = {
 ...
 "docker proof": ("test -S /var/run/docker.sock", "docker version"), "settings proof": ("uv run python", "load_runtime_settings", "runtime-settings-preflight=PASS"),
 ...
 "providers disabled": ("MAYAK_AVITO_LIVE_ENABLED: \"false\"", "MAYAK_TELEGRAM_LIVE_ENABLED: \"false\"", "MAYAK_MAX_LIVE_ENABLED: \"false\"", "MAYAK_YOOKASSA_LIVE_ENABLED: \"false\""),
}
