...
RULES = {
 ...
 "fresh db": ("CREATE DATABASE", "fresh-db-current-shell-binding=PASS", "uv run alembic upgrade head"),
...
def validate(text: str) -> list[str]:
    ...
    order = ["Install pinned Docker CLI and buildx before gates", "Create NEW post-suite database and migrate from zero", "FINAL post-suite C0-C10 on NEW database"]
