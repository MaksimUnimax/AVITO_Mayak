...
def run(
    ...
    observations: dict[str, Any] = {
        ...
        "rollback_witness": {
            "baseline_counts": runtime["rollback_baseline"],
            "in_transaction_counts": runtime["rollback_in_transaction"],
            "post_rollback_counts": runtime["rollback_post"],
            "retry_outcome": "SUCCEEDED" if runtime["rollback_retry_succeeded"] else "FAILED",
            "retry_business_effect_count": runtime["retry_business_effect_count"],
        },
        "ownership_witness": {
