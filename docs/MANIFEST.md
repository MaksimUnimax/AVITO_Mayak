...
- RF-06 is active at repository-evidence level; original RF-06-01 publication at `85f520a179d6399337c94cb3a8a4e5bd46c1c664` is rejected for stale uv candidate and its corrective chain is published for independent acceptance. The authoritative candidate is in the correction artifact. CPython/uv are not installed, dependencies are unchanged, runtime is not deployed, RF-06-02 and RF-07 are blocked; RF-08–RF-30 remain not started/not accepted.
...
- `docs/04-modules/14-runtime-foundation-and-autonomous-integration/TOOLCHAIN_AND_DEPENDENCY_BASELINE_CORRECTION_v1.0.md` — RF-06-01 corrective chain published for independent acceptance; original uv candidate rejected as stale; authoritative candidate recorded here; no installation; `NOT_PRODUCTION_READY`.
...
|---|---|---|
| `00-governance` | rules, current state, roadmap, decisions and worklog | RF-05 accepted; RF-06-01 corrective chain published pending independent acceptance; `NOT_PRODUCTION_READY` |
...
| `02-architecture` | architecture, technical, security, data and compatibility | RF-04/RF-05 accepted; RF-06-01 corrective chain published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
| `03-contracts` | common and public module contracts | accepted semantic foundation |
| `04-modules` | modules 01–13 plus cross-cutting Module 14 | RF-05 accepted; RF-06-01 corrective chain published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
...
| `06-reports` | accepted reports and module handoffs | RF-05 accepted; RF-06-01 corrective chain published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
| `07-quality` | strategy, fixtures, acceptance and regression | RF-05 accepted; RF-06-01 corrective chain published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
| `08-operations` | isolation, environments, observability, recovery, release and Windows egress | RF-05 accepted; RF-06-01 corrective chain published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
| `09-references` | external evidence and provider policies | RF-05 accepted; RF-06-01 corrective chain published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
