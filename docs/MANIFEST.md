...
17. `docs/04-modules/14-runtime-foundation-and-autonomous-integration/CI_SECURITY_AND_SUPPLY_CHAIN_FOUNDATION_v1.0.md` — RF-07-02; `PUBLISHED_PENDING_ACCEPTANCE`.
17. `docs/00-governance/OPEN_DECISIONS.md`
18. relevant append-only decision and worklog entries
19. affected architecture, contract, module, quality, operations and reference documents
20. affected module evidence handoffs
...
- RF-06 is independently accepted through `f03e97ec433e9278247a15dafcb1d96387132eba`; RF-07 is active; RF-07-01 is independently accepted through `01752323937aef4e247b22b5d79676d5e8f61e46`; RF-07-02-C01 is independently accepted through `7c594e49db75cce8a6f411fa0c8ceea59d8b0518`; RF-07-02 is published pending independent acceptance; RF-08–RF-30 remain not started/not accepted.
...
- `docs/04-modules/14-runtime-foundation-and-autonomous-integration/CI_SECURITY_AND_SUPPLY_CHAIN_FOUNDATION_v1.0.md` — version 1.0; RF-07-02; PUBLISHED_PENDING_ACCEPTANCE; workflow and verifier evidence.
