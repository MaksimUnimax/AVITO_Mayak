...
- RF-06-01 corrective chain is accepted at `f77a1d85d7c8b8fd1f2e60694729d1b7c3a1598c`; RF-06-02 exact toolchain bootstrap is published pending independent acceptance. CPython 3.14.6 standard-GIL and uv 0.11.31 are project-owned, dependencies are absent, runtime is stopped, RF-06-03 and RF-07 are blocked; RF-08–RF-30 remain not started/not accepted.
...
- `docs/04-modules/14-runtime-foundation-and-autonomous-integration/TOOLCHAIN_BOOTSTRAP_AND_EXECUTABLE_VERIFICATION_v1.0.md` — RF-06-02 exact pinned toolchain and executable verification, published pending independent acceptance; dependencies absent; runtime stopped; `NOT_PRODUCTION_READY`.
...
|---|---|---|
| `00-governance` | rules, current state, roadmap, decisions and worklog | RF-06-02 published pending independent acceptance; `NOT_PRODUCTION_READY` |
...
| `02-architecture` | architecture, technical, security, data and compatibility | RF-04/RF-05 accepted; RF-06-02 published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
| `03-contracts` | common and public module contracts | accepted semantic foundation |
| `04-modules` | modules 01–13 plus cross-cutting Module 14 | RF-05/RF-06-01 accepted; RF-06-02 published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
...
| `06-reports` | accepted reports and module handoffs | RF-05/RF-06-01 accepted; RF-06-02 published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
| `07-quality` | strategy, fixtures, acceptance and regression | RF-05/RF-06-01 accepted; RF-06-02 published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
| `08-operations` | isolation, environments, observability, recovery, release and Windows egress | RF-05/RF-06-01 accepted; RF-06-02 published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
| `09-references` | external evidence and provider policies | RF-05/RF-06-01 accepted; RF-06-02 published pending independent acceptance; runtime unaccepted; `NOT_PRODUCTION_READY` |
