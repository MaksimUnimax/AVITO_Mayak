...
- `14-runtime-foundation-and-autonomous-integration/CI_SECURITY_AND_SUPPLY_CHAIN_FOUNDATION_v1.0.md` — RF-07-02; correction required; original publication SHA `7814cf7fa8553f75fdbe53c51fd03428e87f4738`.
- `14-runtime-foundation-and-autonomous-integration/CI_SECURITY_SUPPLY_CHAIN_VERIFIER_SELF_TEST_CORRECTION_v1.0.md` — RF-07-02-C02; `CORRECTIVE_REQUIRED`; C02 artifact independently content-verified; first bad object is `scripts/ci/verify_security_supply_chain.py::self_test::ST17_WORKFLOW_PIN_PERMISSION_AND_FORBIDDEN_CHECKS`; primary cause is `WORKFLOW_SECURITY_SELF_TEST_POSITIVE_ONLY_AND_HELPER_FAILS_OPEN_ON_MISSING_ACTIONS_OR_ADDITIONAL_WRITE_PERMISSIONS`.
- `14-runtime-foundation-and-autonomous-integration/CI_SECURITY_WORKFLOW_REJECTION_MATRIX_CORRECTION_v1.0.md` — RF-07-02-C03; `PUBLISHED_PENDING_ACCEPTANCE`; 13/13 ST17 rejection matrix; unchanged workflow YAML; RF-07 active; RF-08 not started; `NOT_PRODUCTION_READY`.
...
**Статус:** `MODULE_14_RF07_WORKFLOW_SECURITY_REJECTION_MATRIX_CORRECTION_PUBLISHED_PENDING_ACCEPTANCE` — RF-06, RF-07-01 and RF-07-02-C01 are independently accepted; C02 SHA is `1ca9b56860d72e13bb21cd437684f95f1a39aa90` and its artifact was independently content-verified but rejected for the exact ST17/helper defect; C03 artifact is `14-runtime-foundation-and-autonomous-integration/CI_SECURITY_WORKFLOW_REJECTION_MATRIX_CORRECTION_v1.0.md`; ST17 proves 13/13 rejection subcases and the workflow YAML is unchanged; RF-07 is active; RF-07-02-C03 is published pending independent acceptance; RF-07-02 is blocked pending C03 acceptance; RF-08 is not started; runtime is stopped; `RUNTIME_ELIGIBLE`; `NOT_PRODUCTION_READY`.
...
RF-02 is independently accepted at `c92e9299e5c0bd11ea18362673a8ac342b835483`. RF-03 is repository-content complete. RF-04 is accepted through current base. RF-05 is independently accepted at `8d502c9baaad5008f79ebc916f9efc3f3378d985`. RF-06, RF-07-01 and RF-07-02-C01 are independently accepted; RF-07-02 is published pending acceptance and RF-07 is active. CPython/uv and dependencies are project-owned, runtime is stopped, and `NOT_PRODUCTION_READY` remains current.
