...
- RF-06 — active at repository-evidence level. The original RF-06-01 publication at `85f520a179d6399337c94cb3a8a4e5bd46c1c664` is rejected for its stale uv candidate; the corrective chain is published for independent acceptance in `TOOLCHAIN_AND_DEPENDENCY_BASELINE_CORRECTION_v1.0.md`. The authoritative candidate is defined only there. RF-05 remains accepted; CPython/uv are not installed, dependencies are unchanged, runtime is not started, RF-06-02 and RF-07 are blocked.

RF-02 closure commit `c92e9299e5c0bd11ea18362673a8ac342b835483` is independently accepted.

RF-04 is accepted through the current base. RF-05 is independently accepted at `8d502c9baaad5008f79ebc916f9efc3f3378d985`. The environment is `RUNTIME_ELIGIBLE`, but runtime implementation/startup is absent and runtime mutation beyond RF-05 allocations is none. RF-06 is active; original RF-06-01 is rejected for stale uv candidate and its corrective chain is published pending independent acceptance. CPython/uv are not installed and dependencies are unchanged. `NOT_PRODUCTION_READY` remains the production verdict; `PRODUCTION_READY` is not claimed. RF-06-02 and RF-07 are blocked.
...
RF-05 is independently accepted at `8d502c9baaad5008f79ebc916f9efc3f3378d985`. RF-06-01 original publication is rejected for stale uv candidate; its corrective chain is published for independent acceptance. The authoritative candidate is in the correction artifact; CPython/uv remain uninstalled, dependencies remain unchanged, and runtime is not started. RF-06-02 and RF-07 are blocked.
