...
Product implementation is forbidden until required documentation gates are accepted. A module cannot start without approved boundaries, owner, contracts, data/compatibility rules, fake dependencies and acceptance checks. External integration requires current official evidence. CLI reports never replace independent GitHub acceptance.
