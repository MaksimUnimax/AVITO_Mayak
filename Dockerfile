...
LABEL org.opencontainers.image.source="https://github.com/MaksimUnimax/AVITO_Mayak" org.opencontainers.image.revision="${SOURCE_SHA}" com.avito-mayak.project-owned="true" com.avito-mayak.lock-identity="${LOCK_IDENTITY}" com.avito-mayak.build-input-digest="${BUILD_INPUT_DIGEST}"
